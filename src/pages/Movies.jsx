...
export default function Movies() {
  ...
  useEffect(() => {
    const baseUrl = query
      ...
      : `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=es-ES&sort_by=${sort}&page=${page}`;
  ...
  return (
    <PageWrapper>
      <section className="px-6 py-20 min-h-screen bg-white text-gray-900 dark:bg-gray-950 dark:text-gray-100 transition-all duration-500">
        <h2 className="text-4xl font-bold mb-6">Buscar películas</h2>
